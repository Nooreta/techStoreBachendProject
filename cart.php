				...
				<div class="col-lg-10 offset-lg-1">
					<div class="cart_container">
						...
						<div class="cart_items">
							<ul class="cart_list">
							<?php foreach($cart->getAll() as $id=>$prodData){   ?>
								<li class="cart_item clearfix">
									<div class="cart_item_image"><img src="<?= URL; ?>upload/<?= $prodData['img']?>" alt=""></div>
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="contact_form_container">
						...
						<form action="<?= URL;?>handlers/order.php" id="order_form" method="POST">
							<div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
								...
								<input type="text" name="mobile" id="contact_form_phone" class="contact_form_phone input_field" placeholder="Your phone number">
							</div>
