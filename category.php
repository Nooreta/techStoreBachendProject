...
$pr=new product;
$prods=$pr->selectWhere("categoryId=$id","id,name,productImg,price");
?>
			...
			<div class="row">
				<div class="col-lg-3">
					...
					<div class="shop_sidebar">
                        ...
                        foreach($cats as $cat):
                           ?>
                            <li><a href="category.php?id=<?= $cat['id']; ?>"><?php echo $cat['name'] ?><i class="fas fa-chevron-right ml-auto"></i></a></li>
                          <?php endforeach; ?>
							</ul>
						</div>
					...
					<div class="shop_content">
						...
						<div class="product_grid">
							...
							<div class="product_item">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="upload/<?= $prod['productImg'] ?>" alt=""></div>
