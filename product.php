...
$pr=new product;
$prod=$pr->selectId($id,"products.id as prodId,products.name as prodName,description,price,productImg,category.name as catName");
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 order-lg-2 order-1">
					<div class="image_selected"><img src="<?= URL; ?>upload/<?= $prod['productImg'];  ?>" alt=""></div>
				</div>
							...
							<form action="<?= URL; ?>handlers/add-cart.php" method="POST">
								<div class="clearfix" style="z-index: 1000;">
									...
									<div class="product_quantity clearfix">
                                        ...
                                        <input type="hidden" name="id" id="" value="<?= $prod['prodId'];   ?>">
										<input type="hidden" name="name" id="" value="<?= $prod['prodName']   ?>">
										<input type="hidden" name="price" id="" value="<?= $prod['price']  ?>">
										<input type="hidden" name="prodImg" id="" value="<?= $prod['productImg'] ?>">
								...
								<?php else:	?>
									<div class="button_container">
							     	<button type="submit" name="submit" class="button cart_button">This product is already added to the cart!!</button>
						        	</div>
								<?php endif; ?>
							</form>
						</div>
