...
$pr=new product;
$prods=$pr->selectAll("id,name,price,productImg");
						...
						<div class="product_grid">
                           ...
                           <?php foreach($prods as $prod): ?>
							...
							<div class="product_item">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<?= URL;?>upload/<?= $prod['productImg'];  ?>" alt=""></div>
